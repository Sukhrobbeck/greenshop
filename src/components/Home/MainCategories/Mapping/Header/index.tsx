...
const Header: FC = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full">
      <div className="flex gap-[35px] cursor-pointer text-neutral-700 text-[15px] font-bold transition-colors hover:border-b-[#46a358] border-spacing-1 max-[400px]:gap-[15px] max-[400px]:text-sm">
        <p
