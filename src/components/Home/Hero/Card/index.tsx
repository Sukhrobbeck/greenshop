...
const Card: FC<CardType> = ({ title, button_text, flower_url, img_index }) => {
  return (
    <div className="h-[450px] relative bg-[#f5f5f5] flex mt-3 max-2xl:h-[400px] max-md:h-[300px]">
      <div className="flex-[2] pl-10">
        <h3 className="font-medium text-base text-[#3d3d3d] mt-[68px] max-lg:text-sm max-md:text-xs max-md:mt-[15px] font-['Inter']">
        ...
        <button className="mt-[40px] w-[140px] h-[40px] bg-green-500 rounded-md text-white text-base font-bold font-['Inter'] uppercase leading-tight">
          {button_text}
        </button>
      </div>
